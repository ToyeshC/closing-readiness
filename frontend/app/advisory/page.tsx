...
function AiDisclosureBanner({ onDismiss }: { onDismiss: () => void }) {
  return (
    <div className="flex items-start justify-between gap-3 px-4 py-3 bg-[var(--color-brand-cream-deep)] border border-[var(--color-brand-line)] rounded-lg text-xs text-[var(--color-brand-muted)] mb-5 motion-safe:animate-fade-in-up">
      <p>
        <span className="font-semibold text-[var(--color-brand-ink)]">AI-generated output.</span>{" "}
        This analysis was generated by Claude AI (Anthropic). All outputs require human review before action.
      </p>
      <button
        onClick={onDismiss}
        className="shrink-0 text-[var(--color-brand-muted)] hover:text-[var(--color-brand-ink)] leading-none"
        aria-label="Dismiss"
      >
        ✕
      </button>
    ...
    <main className="min-h-screen bg-[var(--color-brand-cream)] flex flex-col">
      ...
      <div className="max-w-3xl mx-auto w-full px-6 sm:px-8 py-10 flex-1">
        ...
        {readiness.advice_ready ? (
          ...
          <>
            <div className="mb-4 p-4 bg-[var(--color-brand-rose)]/15 border border-[var(--color-brand-rose)] rounded-lg motion-safe:animate-fade-in-up">
